              ...
              <div class='context-body'>
                ...
                <div class='context-four'>
                  <div class='context-four-item'>
                    ...
                    <p>Engagement was declining, with the existing one-size-fits-all class model not working equally well for every student.</p>
                  </div>
                  <div class='context-four-item'>
                    <div class='context-step'>02<span>→</span></div>
                    <div class='context-icon'>◫</div>
                    <h3>THE<br>SEGMENTATION</h3>
                    <p>Students were analysed across A1, A2 and A3 proficiency cohorts to understand how their classroom needs differed.</p>
                  </div>
                  <div class='context-four-item'>
                    <div class='context-step'>03<span>→</span></div>
                    <div class='context-icon'>◇</div>
                    <h3>THE<br>DIAGNOSIS</h3>
                    <p>A3 learners showed distinct needs around motivation, confidence, language, tutor interaction and concept clarity.</p>
                  </div>
                  <div class='context-four-item'>
                    <div class='context-step'>04<span>→</span></div>
                    <div class='context-icon'>↗</div>
                    <h3>MY<br>ROLE</h3>
                    <p>Translate the analysis into a proficiency-based class model spanning tutor, class dynamics and content.</p>
                  </div>
                </div>
              </div>
            </div>
